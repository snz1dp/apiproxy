...
- 字段要点
  ...
  - ownerapp_id、action（completions/responses/audio_speech/audio_transcriptions/audio_translations/embeddings/images_edits/images_generations/images_variations/videos_generations/videos_retrieve/videos_cancel/videos_content/healthcheck/rerankdocs）、model_name
